...
import "../Procurement/Procurement.scss"
        ...
        <div className="procurement">
            ...
            >
                <section className="wrapper m-3 p-5 d-none d-lg-block">
                    <h5 className="text-white" style={{ textTransform: "uppercase" }}>building with your help</h5>
                    <div className="display-1 w-50 sub-heading d-none d-lg-block">
                        PROCUREMENT
                    </div>
                </section>
                <section className="wrapper d-block d-lg-none">
                    <h5 className="text-white">building with your help</h5>
            ...
            <section className="p-5 d-none d-lg-block" style={{ background: "#d4a74f" }}>
                <div className="form">
                    ...
                    <p className="m-3 text-center">Register your email for the latest updates on our tender and other related information</p>
                    <div >
